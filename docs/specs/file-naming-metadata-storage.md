...
> **Performer credits are canonical metadata for commercial content regardless of content kind. Filename grammars expose this metadata by including a deterministic performer projection for all content kinds (film, episodic, personal, and scene).**
>
> ⭐ **The filenames do not change to reflect this.** Film, episodic and personal names now include up to 3 performers, just as scene names always have.
